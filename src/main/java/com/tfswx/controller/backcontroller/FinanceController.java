...
public class FinanceController extends BaseController {
    ...
    public String sortFront(@PathVariable String lastId,@PathVariable String id,Model model){
        financeService.sortFront(CommonUtils.restFulConverter(lastId),CommonUtils.restFulConverter(id));
        model.addAttribute("id",4);
        return "back/index";
    }
    ...
    public String sortDown(@PathVariable String nextid,@PathVariable String id,Model model){
        financeService.sortDown(CommonUtils.restFulConverter(nextid),CommonUtils.restFulConverter(id));
        model.addAttribute("id",4);
        return "back/index";
    }
}
