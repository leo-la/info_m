...
public class QualityController extends BaseController {
    ...
    public String sortFront(@PathVariable String lastId,@PathVariable String id,Model model){
        qualityService.sortFront(CommonUtils.restFulConverter(lastId),CommonUtils.restFulConverter(id));
        model.addAttribute("id",5);
        return "back/index";
    }
    ...
    public String sortDown(@PathVariable String nextid,@PathVariable String id,Model model){
        qualityService.sortDown(CommonUtils.restFulConverter(nextid),CommonUtils.restFulConverter(id));
        model.addAttribute("id",5);
        return "back/index";
    }
}
