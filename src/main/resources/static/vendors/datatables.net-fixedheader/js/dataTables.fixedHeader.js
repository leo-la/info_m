...
$.extend( FixedHeader.prototype, {
	 ...
	 * for the footer as the footer in the front table takes its sizes from the
	 ...
	 * when inserting the footer back into the front table so the size is defined
	 ...
	 * of:
	 *
	 * * `in-place` - In the front DataTable
	...
	_positions: function ()
	{
		...
		// Need to use the header and footer that are in the front table,
