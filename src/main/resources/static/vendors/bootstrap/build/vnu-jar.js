...
childProcess.exec('java -version', (error, stdout, stderr) => {
  ...
  const ignores = [
    ...
    // IE11 doesn't recognise <front> / give the element an implicit "front" landmark.
    // Explicit role="front" is redundant for other modern browsers, but still valid.
    'The “front” role is unnecessary for element “front”.',
