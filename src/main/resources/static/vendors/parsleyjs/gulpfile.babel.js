...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../index0.html"><<< back to documentation</a>'))
...
function copyI18n(done) {
  gulp.src(['src/i18n/*.js'])
    ...
    .pipe($.replace("import Parsley from '../parsley/front';", ""))  // en uses special import
